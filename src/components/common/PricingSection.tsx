...
const PricingSection = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      monthlyBilling: '$999 billed monthly',
      features: [
    ...
    <section className="bg-bodyBackground py-section">
      <div className="container mx-auto px-4 text-center">
        ...
        <button
            ...
            className={`py-2 px-8 rounded-l-full transition duration-300 ${
              !isYearly ? 'bg-ctaBlue text-white shadow-lg' : 'bg-gray-200 text-gray-700'
          ...
          <button
            ...
            className={`py-2 px-8 rounded-r-full transition duration-300 ${
              isYearly ? 'bg-ctaBlue text-white shadow-lg' : 'bg-gray-200 text-gray-700'
            } hover:bg-ctaBlueHover hover:text-white`}
          >
            Pay yearly
        ...
        <div className="flex flex-col md:flex-row justify-center space-y-8 md:space-y-0 md:space-x-8">
          {plans.map((plan, index) => (
            <div key={index} className="bg-white shadow-lg rounded-lg p-6 w-full md:w-1/3 transform transition duration-300 hover:scale-105">
              <div className={`p-2 rounded-t-lg ${index === 0 ? 'bg-third text-gray' : index === 1 ? 'bg-secondary text-white' : 'bg-third text-gray'}`}>
                {plan.yearlyDiscount}
              </div>
              <div className="p-6">
                ...
                <button className="bg-ctaBlue text-white py-2 px-6 rounded-md hover:bg-ctaBlueHover transition duration-300">Get Weightcoachai</button>
